...
def load_darwin_april15_28_data():
    ...
    print("🛰️  DARWIN foF2 ANALYSIS - APRIL 15-28th (7 YEARS)")
    print("="*65)
    ...
    try:
        ...
        print(f"✅ Loaded Darwin April 15-28th data: {len(df_april15_28):,} records")
...
def create_darwin_april15_28_analysis(darwin_data):
    ...
    print(f"\n📊 Creating Darwin April 15-28th foF2 analysis across 7 years...")
    ...
    print(f"\n🎉 DARWIN APRIL 15-28th foF2 ANALYSIS COMPLETE!")
...
def print_april15_28_summary(darwin_data, yearly_stats, all_fof2_values):
    ...
    print(f"\n🎯 DARWIN APRIL 15-28th foF2 ANALYSIS SUMMARY")
    print("="*65)
    ...
    print(f"\n🔬 SCIENTIFIC INSIGHTS:")
    print(f"  • April 15-28th represents late autumn ionospheric conditions")
    print(f"  • 14-day period provides robust statistical sampling")
...
def main():
    ...
    if darwin_data:
        ...
        print("❌ No Darwin April 15-28th data could be loaded")
