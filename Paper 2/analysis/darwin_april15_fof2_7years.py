...
def load_darwin_april15_data():
    ...
    print("🛰️  DARWIN foF2 ANALYSIS - APRIL 15th (7 YEARS)")
    print("="*60)
    ...
    try:
        ...
        print(f"✅ Loaded Darwin April 15th data: {len(df_april15):,} records")
...
def create_darwin_april15_analysis(darwin_data):
    ...
    print(f"\n📊 Creating Darwin April 15th foF2 analysis across 7 years...")
    ...
    print(f"\n🎉 DARWIN APRIL 15th foF2 ANALYSIS COMPLETE!")
...
def print_april15_summary(darwin_data, yearly_stats, peak_times, peak_values):
    ...
    print(f"\n🎯 DARWIN APRIL 15th foF2 ANALYSIS SUMMARY")
    print("="*60)
    ...
    print(f"\n🔬 SCIENTIFIC INSIGHTS:")
    print(f"  • April 15th shows consistent ionospheric patterns")
    print(f"  • Peak foF2 occurs around {avg_peak_time:04.1f} local time")
    print(f"  • 7-year data provides robust statistical baseline")
...
def main():
    ...
    if darwin_data:
        ...
        print("❌ No Darwin April 15th data could be loaded")
