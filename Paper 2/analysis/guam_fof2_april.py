...
def load_guam_data():
    ...
    print("🛰️  GUAM foF2 ANALYSIS - APRIL")
    print("="*45)
    ...
    try:
        ...
        print(f"✅ Loaded Guam April data: {len(df_april):,} records")
...
def create_guam_fof2_plots(guam_data):
    ...
    print(f"\n📊 Creating individual Guam foF2 analysis charts for April...")
    ...
    print(f"\n🎉 INDIVIDUAL GUAM foF2 CHARTS CREATED!")
...
def print_guam_fof2_summary(guam_data, fof2_values):
    ...
    print(f"\n🎯 GUAM foF2 ANALYSIS SUMMARY - APRIL")
    print("="*45)
    ...
    print(f"\n🔬 SCIENTIFIC INSIGHTS:")
    print(f"  • Guam provides Northern Pacific reference for DGFC")
    print(f"  • April foF2 values typical for Northern Pacific region")
...
def main():
    ...
    if guam_data:
        ...
        print(f"\n🎉 GUAM foF2 ANALYSIS COMPLETE!")
        print(f"📁 Charts saved to: /Users/samanthabutterworth/PycharmProjects/pythonProject3/")
    else:
        print("❌ No Guam data could be loaded")
